...
来源链接: https://leetcode.com/problems/binary-search-tree-to-greater-sum-tree/
---
...
- `0 https://leetcode.cn/problems/convert-bst-to-greater-tree/  相同
...
```go
// Binary Search Tree to Greater Sum Tree：按照上方思路实现主解法。
