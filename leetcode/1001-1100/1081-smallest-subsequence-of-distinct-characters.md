...
难度: 中等
标签: [栈, 贪心, 字符串, 单调栈]
来源链接: https://leetcode.com/problems/smallest-subsequence-of-distinct-characters/
---
...
- `1 https://leetcode.cn/problems/remove-duplicate-letters/ 相同
...
```go
// Smallest Subsequence of Distinct Characters：按照上方思路实现主解法。
