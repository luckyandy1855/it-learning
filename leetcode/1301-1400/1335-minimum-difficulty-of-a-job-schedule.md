...
---
编号: 1335
题目: Minimum Difficulty of a Job Schedule
难度: 困难
标签: [数组, 动态规划]
来源链接: https://leetcode.com/problems/minimum-difficulty-of-a-job-schedule/
---
...
```go
// Minimum Difficulty of a Job Schedule：按照上方思路实现主解法。
