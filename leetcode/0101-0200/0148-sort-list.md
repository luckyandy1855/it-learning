...
来源链接: https://leetcode.com/problems/sort-list/
---
...
提示：
	...
	- `-10^5 进阶：你可以在 `O(n log n)` 时间复杂度和常数级空间复杂度下，对链表进行排序吗？
...
2. **选择主结构**：根据标签「链表, 双指针, 分治, 排序, 归并排序」和题目约束，优先考虑哈希表、双指针、栈/队列、树遍历、动态规划或数学化简。
