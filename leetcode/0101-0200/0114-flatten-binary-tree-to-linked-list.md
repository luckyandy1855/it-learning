...
来源链接: https://leetcode.com/problems/flatten-binary-tree-to-linked-list/
---
...
2. **选择主结构**：根据标签「栈, 树, 深度优先搜索, 链表, 二叉树」和题目约束，优先考虑哈希表、双指针、栈/队列、树遍历、动态规划或数学化简。
...
```go
// Flatten Binary Tree to Linked List：按照上方思路实现主解法。
