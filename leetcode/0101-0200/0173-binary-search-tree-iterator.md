...
来源链接: https://leetcode.com/problems/binary-search-tree-iterator/
---
...
2. **选择主结构**：根据标签「栈, 树, 设计, 二叉搜索树, 二叉树, 迭代器」和题目约束，优先考虑哈希表、双指针、栈/队列、树遍历、动态规划或数学化简。
...
```go
// Binary Search Tree Iterator：按照上方思路实现主解法。
